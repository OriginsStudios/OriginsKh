...
export default function BlogPage({ params }: BlogPageProps) {
  const blog: Blog | undefined = blogs.find((b) => b.id === params.id);
              ...
              <div className="prose prose-lg max-w-none">
                ...
                {blog.content && blog.content.length > 0 ? (
                  ...
                  <div className="space-y-6 text-gray-800 leading-relaxed">
                    <p>
                      This blog post is coming soon. Please check back later for the full content.
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="bg-black text-white py-24">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              solutions. From custom software development to innovative design,
              we help businesses like yours achieve their digital transformation
              goals.
            </p>
