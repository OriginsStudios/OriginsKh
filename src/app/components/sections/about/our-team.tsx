        ...
        <div className="w-full">
          ...
          <div className="pt-16 sm:pt-32">
            <div className="flex flex-row items-center justify-between gap-8">
              ...
              <Link
                href="/hiring"
                className="shrink-0 flex items-center px-6 py-3 bg-stone-900 text-stone-50 rounded-full font-semibold uppercase tracking-[0.2em] hover:bg-amber-700 transition-colors text-xs md:text-sm"
              >
                Hiring
                <motion.div
                  className="ml-3"
